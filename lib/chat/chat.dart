...
import 'package:flutter_chat_demo/utils/const.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Future uploadFile() async {
    ...
    storageTaskSnapshot.ref.getDownloadURL().then((downloadUrl) {
      ...
      Fluttertoast.showToast(msg: ' Этот файл не картинка, выбрите изображение ');
    });
  }
  ...
  void onSendMessage(String content, int type) {
    ...
    if (content.trim() != '') {
      ...
      Fluttertoast.showToast(msg: ' Поля пуст ');
    }
  }
              ...
              children: <Widget>[
                isLastMessageLeft(index)
                    ? Material(                        
                        ...
                        child: SvgPicture.asset(peerAvatar,height: 35,width: 35,),
                        clipBehavior: Clip.hardEdge,
                      )
